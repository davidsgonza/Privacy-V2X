...
# Configuración básica de seaborn para mejorar la apariencia del gráfico
...
if __name__ == "__main__":
    ...
    #prs.add_argument("-yaxis", type=str, default="system_total_C02_emissions", help="The column to plot.\n")
    ...
    #prs.add_argument("-ylabel", type=str, default="Emisiones de C02", help="Y axis label.\n")
    prs.add_argument("-ylabel", type=str, default="Tiempo de espera (S)", help="Y axis label.\n")
    ...
    # Lectura de archivos y agrupación
    for file in args.f:
        ...
        # Graficar DataFrame
        plot_df(main_df, xaxis=args.xaxis, yaxis=args.yaxis, label=next(labels), color= 'blue', ma=args.ma)
